...
namespace KairusDarkSeeker\PrivateVaults;
...
class PrivateVaults extends PluginBase implements Listener {
	...
	public function onLoad() {
		if(@array_shift($this->getDescription()->getAuthors()) != "\x4b\x61\x69\x72\x75\x73\x44\x61\x72\x6b\x53\x65\x65\x6b\x65\x72" || $this->getDescription()->getName() != "\x50\x72\x69\x76\x61\x74\x65\x56\x61\x75\x6c\x74\x73") {
